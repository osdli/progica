 ...
 */
final class Version20220325134408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lodge ADD regions_id INT UNSIGNED NOT NULL');
        $this->addSql('ALTER TABLE lodge ADD CONSTRAINT FK_A11F814FFCE83E5F FOREIGN KEY (regions_id) REFERENCES regions (id)');
        $this->addSql('CREATE INDEX IDX_A11F814FFCE83E5F ON lodge (regions_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lodge DROP FOREIGN KEY FK_A11F814FFCE83E5F');
        $this->addSql('DROP INDEX IDX_A11F814FFCE83E5F ON lodge');
        $this->addSql('ALTER TABLE lodge DROP regions_id, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(500) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE picture picture VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE location location VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
