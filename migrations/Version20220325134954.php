 ...
 */
final class Version20220325134954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lodge ADD departements_id INT NOT NULL');
        $this->addSql('ALTER TABLE lodge ADD CONSTRAINT FK_A11F814F1DB279A6 FOREIGN KEY (departements_id) REFERENCES departements (id)');
        $this->addSql('CREATE INDEX IDX_A11F814F1DB279A6 ON lodge (departements_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE lodge DROP FOREIGN KEY FK_A11F814F1DB279A6');
        ...
        $this->addSql('DROP INDEX IDX_A11F814F1DB279A6 ON lodge');
        $this->addSql('ALTER TABLE lodge DROP departements_id, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(500) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE picture picture VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE location location VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
